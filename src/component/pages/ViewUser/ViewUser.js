...
import CallLiveStatus from "./CallLiveStatus";
...
export default function ViewUser(props) {
  ...
  var userrData = JSON.parse(localStorage.getItem("user"));
  ...
  return (
    <>
      <div class="container-fluid">
        ...
        <CallStatus getData={getData} {...props} />
        <CallLiveStatus getData={getData} {...props} />
        <div class="card">
          <Box sx={{ width: "100%" }}>
            <Box
            ...
            <TabPanel value={value} index={0}>
              <AttendanceView getData={getData} {...props} />
            </TabPanel>
            <TabPanel value={value} index={1}>
              <CustomerView getData={getData} {...props} />
            </TabPanel>
            <TabPanel value={value} index={2}>
              <TaskView getData={getData} {...props} />
            </TabPanel>
            <TabPanel value={value} index={3}>
              <CallsView getData={getData} />
            </TabPanel>
          </Box>
        </div>
      </div>
