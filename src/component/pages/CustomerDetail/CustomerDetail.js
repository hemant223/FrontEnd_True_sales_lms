...
import CustomerGraph from "./CustomerComponent/CustomerGraph";
...
function CustomerDetail(props) {
  ...
  const handleEditCustomer = (item) => {
    props.handleDashComponent("", <EditCustomer {...props} item={item} />);
  };

  const handleBack = () => {
    {
      props.getData != undefined
        ? props.handleDashComponent("", <ViewUser {...props} />)
                      ...
                      <div class="col-12 col-md-12">
                        ...
                        >
                          <button
                            ...
                            onClick={() => handleEditCustomer(getCustomerdata)}
                          >
