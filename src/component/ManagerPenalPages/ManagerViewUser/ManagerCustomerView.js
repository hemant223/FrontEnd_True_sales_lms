...
import ManagerCustomerDetails from "../ManagerCustomerDetail/ManagerCustomerDetails";
import { PaginationItem } from "@mui/material";

export default function ManagerCustomerView(props) {
  ...
  const handleViewPage = (item) => {
    props.handleDashComponent(
      "",
      <ManagerCustomerDetails {...props} customerDetail={item} />
    );
  };
