...
import ManagerCustomerView from "./ManagerCustomerView";
import ManagerTaskView from "./ManagerTaskView";
import ManagerCallsView from "./ManagerCallsView";
import ManagerCallLiveStatus from "./ManagerCallLiveStatus";
...
export default function ManagerViewUser(props) {
  // console.log("props in ViewUser", props);
  const [value, setValue] = useState(0);
  const [getData, setData] = useState(props.userInfo);
  ...
  return (
    <>
      <div class="container-fluid">
        ...
        <ManagerCallLiveStatus getData={getData} {...props} />
        <div class="card">
          <Box sx={{ width: "100%" }}>
            <Box
            ...
            <TabPanel value={value} index={0}>
              <ManagerAttendanceView getData={getData} {...props} />
            </TabPanel>
            <TabPanel value={value} index={1}>
              <ManagerCustomerView getData={getData} {...props} />
            </TabPanel>
            <TabPanel value={value} index={2}>
              <ManagerTaskView getData={getData} {...props} />
            </TabPanel>
            <TabPanel value={value} index={3}>
              <ManagerCallsView getData={getData} {...props} />
            </TabPanel>
          </Box>
        </div>
      </div>
