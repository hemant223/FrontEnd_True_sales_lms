...
export default function ManagerAttendanceReport(props) {
  ...
  const fetchAttendanceReport = async () => {
    try {
      let response = await getDataAxios(
        `attendence/managerPenalAttendenceReport/${CompanyId}/${userData.id}`
      );
      if (response.status) {
        setAttendanceReport(response.arr);
        setTempTableData(response.arr);
  ...
  const handleFilter = async () => {
    try {
      ...
      let response = await postDataAxios(
        `attendence/managerPenalFilterAttendenceReport/${userCompanyId.company_id}/${userData.id}`,
        body
      );
  ...
  const showEmployee = (i) => {
    ...
    return (
      <tr>
        ...
        <td> {teamname}</td>
        <td> {date} </td>
        <td style={{ textAlign: "center" }}> {in_time} </td>
        <td style={{ textAlign: "center" }}> {out_time}</td>
        <td> {totalbrk} </td>
        <td style={{ textAlign: "center" }}> {durations} </td>
        <td>
          {attenstatus == "out" ? (
        ...
        <td style={{ textAlign: "center" }}> {breakStartTime} </td>
        <td style={{ textAlign: "center" }}> {breakEndTime} </td>
        <td style={{ textAlign: "center" }}> {breakDate} </td>
        <td style={{ textAlign: "center" }}> {breakType} </td>
      </tr>
    );
  };
                              ...
                              <div class="row ">
                                ...
                                >
                                  ...
                                  <CSVLink
                                    ...
                                    filename={`${userData.name} ManagerPenal Attendance_Report.csv`}
                                  >
                                    <button
                                      type="button"
