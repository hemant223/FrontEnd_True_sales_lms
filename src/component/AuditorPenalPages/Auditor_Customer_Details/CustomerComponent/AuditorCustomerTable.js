...
export default function AuditorCustomerTable(props) {
  ...
  const showEmployee = (i) => {
    console.log("getting status--->", CustomerTableData[i].disposition);
    // const Aud = new Audio(`CustomerTableData[i].recording_url}`)
    let id = "";
    let calltype = "";
    let username = "";
    let created = "";
  ...
  const nextPage = () => {
    ...
    setEntryEnd(
      entryEnd + entriesPerPage > CustomerTableData.length
        ? CustomerTableData.length
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    >
                      ...
                      <li class="page-item">
                        ...
                        >
                          <span aria-hidden="true">
                            {entryStart === 0 ||
                            CustomerTableData.length < entriesPerPage ? (
                              <div style={{ color: "#8395a7" }}>Previous</div>
                            ) : (
                              // <div>
                              <a
                                href={() => false}
                      ...
                      {/* <li class="page-item">
                        ...
                        >
                          <span aria-hidden="true">
                            {CustomerTableData.length === entryEnd ||
                            CustomerTableData.length <= entriesPerPage ? (
                              <div
                                style={{
                                  color: "#8395a7",
